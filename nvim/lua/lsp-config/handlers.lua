...
local function lsp_keymaps(bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gv", ":vsp<cr>:lua vim.lsp.buf.definition()<CR>", opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "go", ":vsp<cr>:lua vim.lsp.diagnostic.show_line_diagnostics()<CR>", opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gt", ":tab split<cr>:lua vim.lsp.buf.definition()<CR>", opts)
