...
function M.groups(palette)
	return {
		...
		Visual = { bg = palette.accent20 },
		VisualNOS = { fg = palette.accent20 },
		...
		["@tag.attribute"] = { fg = palette.accent6 },
		["@property"] = { fg = palette.accent6 },
		["@parameter"] = { fg = palette.accent7 },
		...
		TelescopeMatching = { fg = palette.accent3 },
		...
		NvimTreeFolderIcon = { fg = palette.accent2 },
		...
		DiagnosticInfo = { fg = palette.accent7, bg = palette.accent12 },
		DiagnosticHint = { fg = palette.accent7, bg = palette.accent12 },
		...
		DiagnosticSignInfo = { fg = palette.accent7, bg = palette.accent12 },
		DiagnosticSignHint = { fg = palette.accent7, bg = palette.accent12 },
		DiagnosticFloatingError = { fg = palette.accent5 },
		DiagnosticFloatingWarn = { fg = palette.accent3 },
		DiagnosticFloatingInfo = { fg = palette.accent7, bg = palette.accent12 },
		DiagnosticFloatingHint = { fg = palette.accent7, bg = palette.accent12 },
		...
		LspDiagnosticsDefaultInformation = { fg = palette.accent7, bg = palette.accent12 },
		LspDiagnosticsDefaultHint = { fg = palette.accent7, bg = palette.accent12 },
		LspDiagnosticsUnderlineError = { fg = palette.accent5, undercurl = true },
		LspDiagnosticsUnderlineWarning = { fg = palette.accent7, bg = palette.accent12, undercurl = true },
		LspDiagnosticsUnderlineInformation = { fg = palette.accent7, bg = palette.accent12, undercurl = true },
		LspDiagnosticsUnderlineHint = { fg = palette.accent7, bg = palette.accent12, undercurl = true },
